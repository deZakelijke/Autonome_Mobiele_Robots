...
%
%   Author Davide Scaramuzza - davsca@tiscali.it
%   Ecole Polytechnique Federal de Lausanne - EPFL , March, 10, 2006

function Iunwraped=imunwrap(I, center, Rmax, Rmin, bilinear)
